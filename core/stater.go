...
import (
	...
	pmexec "github.com/FasterEdge/DontCrack4Mac/exec"
	dclog "github.com/FasterEdge/DontCrack4Mac/log"
	"io"
	"log"
	"net"
	"net/http"
...
const rootMsg = "DontCrack_mac By FasterEdge"
...
func Start(cfg config.Config) {
	...
	log.Printf("DontCrack_mac v%s 启动中...\n", cfg.Version)
...
// 在 /bin/sh 中执行启动前命令（标准 Linux 通用，无需探测）
